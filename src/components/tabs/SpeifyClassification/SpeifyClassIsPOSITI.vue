...
export default {
  ...
  methods: {
    ...
    initpositionValue() {
      //初始化岗位
      this.positionValue = this.$store.state.readUsertaskElementextensionElements.positionValue;
      let assigneeuserOrgScope = this.moddle.create("flowable:positionValue", {
      ...
      if (this.positionValue) {
        this.checkList = this.positionValue.split(",");
        this.showRoles = true;
      }
    },
    initIsFixed() {
